...
> Generated by project-init on 2026-09-06 02:36:27
...
- Branch: main
- Tech stack: Docker
- Last commit: Merge branch 'main' of https://github.com/WillyEverGreen/sentinelcap
...
> Auto-generated by brain-sync. Last synced: 2026-09-06 02:35
...
- **sentinelcap** - Merge branch 'main' of https://github.com/WillyEverGreen/sentinelcap
...
- **Working on**: Merge branch 'main' of https://github.com/WillyEverGreen/sentinelcap
- **Recent**:
  - 85b4de1 docs: rewrite README to improve structure, formatting, and technical documentation coverage
  - 9d896ef feat: complete deployment readiness for Render and Vercel, center navbar, and unify CapitalAI branding
  - 96a3bbe chore: initialize frontend project with gitignore and package-lock files
  - 3d6ebd7 feat(navigation): separate Risk Parameters (/dashboard/risk) and Settings (/dashboard/settings) pages with dynamic header titles
  - d53ec47 ui: restore interactive animated micro-hover logo across website navigation and auth pages
