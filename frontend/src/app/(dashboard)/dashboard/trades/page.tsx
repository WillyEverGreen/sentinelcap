    ...
    <div className="space-y-6 select-none font-sans">
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm space-y-4 overflow-hidden">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-100">
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-[15px] font-bold text-[#0A1128] tracking-tight">Intraday Execution Volume</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 pt-1">
          ...
          {/* Right Panel Section */}
          <div className="lg:col-span-1 rounded-xl bg-slate-50 border border-slate-100 p-5 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2 mb-5">
                <Activity className="w-4 h-4 text-[#0066FF]" />
                <h4 className="text-sm font-bold text-slate-800">Routing Venues</h4>
              </div>
              
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between text-xs mb-1.5">
                    <span className="font-semibold text-slate-700">Goldman Prime</span>
                    <span className="font-mono text-slate-900 font-bold">65%</span>
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-between text-xs mb-1.5">
                    <span className="font-semibold text-slate-700">IEX Direct</span>
                    <span className="font-mono text-slate-900 font-bold">25%</span>
                  </div>
                  <div className="w-full h-1.5 bg-slate-200 rounded-full overflow-hidden">
                ...
                <div>
                  <div className="flex items-center justify-between text-xs mb-1.5">
                    <span className="font-semibold text-slate-700">Fed Liquidity</span>
            ...
            <div className="mt-6 pt-4 border-t border-slate-200">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-semibold text-slate-500">Dark Pool Routing</span>
                <span className="px-2 py-0.5 rounded bg-slate-200 text-slate-600 text-[10px] font-bold">INACTIVE</span>
              </div>
            </div>
          </div>
        </div>
