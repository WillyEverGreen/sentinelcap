        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="rounded-2xl border border-slate-100 bg-slate-50/50 p-6 shadow-sm space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-[14px] font-bold text-[#0A1128]">Contagion Risk Factors</h3>
            </div>
            <ul className="space-y-3">
              <li className="flex items-start gap-2.5">
                <span className="w-1.5 h-1.5 rounded-full bg-rose-500 mt-1.5 shrink-0" />
                <p className="text-[11.5px] text-slate-600 leading-relaxed">
                  <strong className="text-slate-800 block mb-0.5">Liquidity Freeze</strong>
              ...
              <li className="flex items-start gap-2.5">
                ...
                <p className="text-[11.5px] text-slate-600 leading-relaxed">
                  <strong className="text-slate-800 block mb-0.5">Cross-Asset Correlation</strong>
              ...
              <li className="flex items-start gap-2.5">
                ...
                <p className="text-[11.5px] text-slate-600 leading-relaxed">
                  <strong className="text-slate-800 block mb-0.5">Margin Call Spirals</strong>
